...
export default function Beauty() {
    ...
    const Product = record.data.filter(item => item.category === "beauty")
    ...
    return (
        <div>
            ...
            <div className="nav_btn">
                ...
                <button style={{ backgroundColor: "#1d2de5", opacity: "100%" }}>Beauty</button>
                <Link to="/Gift">
                    <button>Gift</button>
                </Link>
                <Link to="/Electronic">
            ...
            <div className="pr_main">
                {
                    Product &&
                    Product.map((e, i) => (
                        <div key={i} className='pr_div beauty'>
