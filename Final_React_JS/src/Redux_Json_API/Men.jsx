...
export default function Men() {
    ...
    const Product = record.data.filter(item => item.category === "men")
    ...
    return (
        <div>
            ...
            <div className="nav_btn">
                ...
                <button style={{backgroundColor: "#1d2de5", opacity: "100%"}}>Men</button>
                <Link to="/Women">
                    <button>Women</button>
                </Link>
                <Link to="/Food">
            ...
            <div className="pr_main">
                {
                    Product &&
                    Product.map((e, i) => (
                        <div key={i} className='pr_div men'>
